...
public class TransferStreamingRequest implements StreamObserver<TransferResponse> {

    private CountDownLatch latch;
    public TransferStreamingRequest(CountDownLatch latch){
        this.latch = latch;
    }
    @Override
